    ...
    <section id="form-registration">
        <div class="container">
            <div class="page-header">
              <h1>REGISTRO <small class="tittles-pages-logo">Tienda ACAINGSOFT</small></h1>
            </div>
            <p class="lead text-center">
              Para ACAINGSOFT es muy importante conocerle y hacerlo parte de nuestra familia, por eso es importante que nos dejes tus datos y hagas parte de nuestro equipo
            </p>
            <div class="row">
                            ...
                            <div class="row">
                              ...
                              <div class="col-xs-12">
                                <div class="form-group label-floating">
                                  <label class="control-label"><i class="fa fa-address-card-o" aria-hidden="true"></i>&nbsp; Ingrese su número de identificacion</label>
                                  <input class="form-control" type="text" required name="clien-nit" pattern="[0-9]{1,15}" title="Ingrese su número de identificacion. Solamente números" maxlength="15" >
                                </div>
                              </div>
                              ...
                              <div class="col-xs-12">
                                <div class="form-group label-floating">
                                  ...
                                  <input class="form-control" type="text" required name="clien-dir" title="Ingrese la direccion donde quiere que llegue su compra" maxlength="100">
                                </div>
                              </div>
                              <div class="col-xs-12">
