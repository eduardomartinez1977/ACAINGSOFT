        ...
        <div class="container">
            <div class="row">
                <div class="page-header">
                    <h1>DETALLE DE PRODUCTO <small class="tittles-pages-logo">Tienda ACAINGSOFT</small></h1>
                </div>
                <?php 
                                ...
                                if($fila['Stock']>=1){
                                    if($_SESSION['nombreAdmin']!="" || $_SESSION['nombreUser']!=""){
                                        echo '<form action="process/carrito.php" method="POST" class="FormCatElec" data-form="">
                                            ...
                                            <label class="text-center"><small>Cantidad de Productos que vas a agregar al carrito (Maximo '.$fila['Stock'].' productos)</small></label>
                                    ...
                                    echo '<p class="text-center text-danger lead">Lo sentimos pero este producto esta agotado</p><br>';
                                }
